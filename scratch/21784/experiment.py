...
def main() -> None:
    ...
    parser.add_argument("--project", default="lightning-log-key-prefix-repro")
    parser.add_argument("--run-name", default=None)
    parser.add_argument(
        "--log-key-prefix",
        default="trainer/",
        help="Prefix passed to Trainer (default: trainer/; requires PR #21784).",
    )
    parser.add_argument("--offline", action="store_true", help="Write a local W&B run instead of uploading it.")
    args = parser.parse_args()

    logger = PrintingWandbLogger(project=args.project, name=args.run_name, offline=args.offline)
    ...
    trainer_args["log_key_prefix"] = args.log_key_prefix
